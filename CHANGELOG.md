...
## v3.7.0 (2026-06-17)
* “行迹”选项卡现在对于部分控制类技能，除了追踪命中人数外，还会追踪生效人数。<br>
  发动技能命中处于净化、防御等免控状态的目标不会计入生效人数。<br>
  ![Preview](https://infsein.github.io/static/frontline-overlay/patchnote/3.7.0/1.jpg)
* “行迹”选项卡的以下重要技能追加对生效人数的追踪：<br>
  - 战士“蛮荒崩裂”、“原初的怒震”
  - 暗黑骑士“腐秽大地”
  - 绝枪战士“终结击”
  - 白魔法师“涤罪之心”
...
## v3.6.0 (2026-05-24)
* “统计”选项卡现在还会显示战意信息（仅限纷争前线）。<br>
  将记录和展示整局游戏中自己获得过的最高档位的“斗志昂扬”。如果达到了“斗志昂扬V”，则还将展示初次达到的用时。<br>
  ![Preview](https://infsein.github.io/static/frontline-overlay/patchnote/3.6.0/1.jpg)
* “关注列表”可关注的玩家数量上限从20提升至30。

## v3.5.2 (2026-04-28)
* 修复“日历”选项卡的轮换规则。

## v3.5.1 (2026-04-28)
* 调整“日历”选项卡，使其适配7.5轮换规则的变更。
* 优化“统计”选项卡中纷争前线季军对战结果的配色。

## v3.5.0 (2026-04-10)
* 支持解析各种反击伤害（绝枪战士“星云”、武士“必杀剑·地天”、黑魔法师“寒冰环”）
* 调整“行迹”选项卡所追踪的重要技能：<br>
  - 追加绝枪战士“星云反击”、武士“地天反击”
  - 移除治疗职业“坚石肤”
...
## v3.3.1 (2026-03-21)
* 优化“战况”选项卡对草原/雪原场合据点排布的处理。
* 优化“统计”选项卡中纷争前线对战结果的文本与配色。
...
* “关注列表”可关注的玩家数量上限从5提升至10。
* 优化了“战况”选项卡对特定场合据点排布的处理。

## v3.2.0 (2026-03-10)
* 增加设置项“关注列表”。<br>
  请在设置面板中查看相应说明。
* 进一步优化设置中各个设置项的说明文本。
* 追加“行迹”选项卡所追踪的重要技能：<br>
  - 绘灵法师“胖胖之墙”、“天星棱光”

## v3.1.3 (2026-03-01)
* 修复了在对战期间重置悬浮窗会导致一直显示“正在等待战斗开始”的问题。 <br>
  ※ 仅在一定程度上修复。另外这一行为还会导致很多其他问题，请尽量避免。 <br>
  ※ _本悬浮窗大体上只面向完整的对战数据设计解析逻辑，因此请尽量避免在对战期间重置悬浮窗。_
* 优化了“战况”选项卡中“当前据点”栏目的布局

## v3.1.2 (2026-02-27)
* 优化“统计”选项卡中对战职业图标的展示方式
* 追加“行迹”选项卡所追踪的重要技能：<br>
  - 学者“展开战术”
  - 武僧“梦幻斗舞”、“金刚转轮”
  - 钐镰客“大丰收”
...
## v3.1.1 (2026-02-23)
* 修复了通过 星遁天诛／完人 触发追加效果击倒目标时，伤害会被解析为「0」而非「即死」的问题
* 优化了设置中各个设置项的说明文本

## v3.1.0 (2026-01-18)
* “战况”选项卡的“当前据点”栏目的布局改为一行多个。<br>
  伴随这一改动，追加了全新设置项「战况」->「“当前据点”布局」。<br>
  如果更喜欢之前版本的布局，可以切换到「经典」模式。<br>
  ![Preview](https://infsein.github.io/static/frontline-overlay/patchnote/3.1.0/1.png)
* “当前据点”栏目的据点卡片现在按照据点价值降序排序。<br>
  ※ 据点价值指该据点被占领后能够提供的分数。
* 追加了对水晶冲突「海岸斗场」地图的解析。
* 追加“行迹”选项卡所追踪的重要技能：追加烈羽争锋机动兵器的部分技能。<br>
  ※ 具体包括：交叉光剑、超大型导弹、大火炎放射、巨型光束炮。
* 优化了一些界面细节
